...
class ProtoMAMLv2(MetaOptimizer):
    ...
    def adapt_and_update(
        ...
        **kwargs: Any,
        ...
        # Re-index categorical labels if a label encoder is registered on the meta-optimizer
    ...
    def step(
        ...
        **kwargs: Any,
        ...
        def process_single_task(x_s, y_s, x_q, y_q, global_buffers, task_weight: float = 1.0, training: bool = True):
            ...
            accumulated_meta_loss = 0.0 if (getattr(self, "backend", "vmap") == "sequential" and training) else torch.tensor(0.0, device=self.device)
                    ...
                    if self.multi_step_loss and not last_step:
                        ...
                        if training:
                            ...
                            if getattr(self, "backend", "vmap") == "sequential":
                                ...
                                scaled_step_loss.backward(retain_graph=True)
